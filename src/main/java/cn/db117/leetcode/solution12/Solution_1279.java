...
/**
 * 1279.红绿灯路口.traffic-light-controlled-intersection
 *
 * @author db117
 * @since 2022-07-18 17:16:48
 **/

public class Solution_1279 {
    public static void main(String[] args) {
        TrafficLight solution = new Solution_1279().new TrafficLight();
    }

    //leetcode submit region begin(Prohibit modification and deletion)
    class TrafficLight {
        Semaphore semaphore = new Semaphore(1);
        boolean oneGreen = true;
        ...
        public void carArrived(
            ...
            try {
                semaphore.acquire();
                if ((roadId == 1 && !oneGreen) || (roadId == 2 && oneGreen)) {
                    // 换灯
                    turnGreen.run();
                    oneGreen = !oneGreen;
                }
