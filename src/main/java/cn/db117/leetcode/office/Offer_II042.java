...
/**
 * 剑指 Offer II 042.最近请求次数.H8086Q
 *
 * @author db117
 * @since 2022-03-25 18:50:17
 **/

public class Offer_II042 {
    public static void main(String[] args) {
        RecentCounter solution = new Offer_II042().new RecentCounter();
    }
